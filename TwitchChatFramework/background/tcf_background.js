var tcfBackground = (function() {
    ...
    chrome.runtime.onMessage.addListener(function(request, sender, callback){
        if(request.type == 'refresh'){
            if(request.data != 'hard'){
                ...
                hardRefreshFunctions.forEach(function(hardRefreshFunction){
                    hardRefreshFunction();
                }) ;     
    ...
    */
    ...
    return {
        ...
        registerHardRefresh : function(callback){
            hardRefreshFunctions.push(callback);
        },
        refresh : refresh,
